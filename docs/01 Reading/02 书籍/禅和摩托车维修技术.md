...
概括下这小节（太重要了）：  
庞加莱认为科学家通过”和谐“来进行”选择“，Phaedrus 指出这种和谐就是 Quality。通过 Phaedrus 的理论，可以解决科学哲学中的一个核心问题：科学如何既能是选择性的，又能是客观的？答案是， Quality 是独立于主观和客观的存在，它是她们的 source，为此，**科学的选择基于对 Quality 的感知，而 Quality 本身就是现实的本质**。
